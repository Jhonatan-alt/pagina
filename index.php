...
<body>
    <section id="home">
        <div class="contenido">
            ...
            <div class="presentacion">
                ...
                <h2>Soy <span>Jhonatan David Martinez Garcia </span> Ingeniero de sistemas</h2>
    ...
    <section id="about">
        ...
        <div class="info_sobreMi">
            ...
            <h2>Soy, <span>Jhonatan Martinez</span></h2>
            <h3>Slogan</h3>
        ...
        <form action="">
            <div class="inputBox">
                ...
                <div class="input">
                    ...
                    <input type="number" placeholder="(+57) 312 5697345">
                </div>
            </div>
            <div class="inputBox">
                <div class="input">
